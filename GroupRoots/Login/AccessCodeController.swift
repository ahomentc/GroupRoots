//
//  AccessCodeController.swift
//  GroupRoots
//
//  Created by Andrei Homentcovschi on 3/29/21.
...
// This comes up after loginPhoneController if accessCodeEnabled in firebase is true
// AccessCodes entree in firebase will have a list of access codes that people can use

class AccessCodeController: UIViewController {
...
extension AccessCodeController: UITextFieldDelegate {
